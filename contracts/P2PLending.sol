...
contract P2PLending is IP2PLending {
     ...
     */
    function newLoanRequest(uint256 _loanTokenId, uint256 _loanAmount, uint256 _interest, uint256 _loanDuration) public returns(uint256){}
     ...
     */
    function newLoanOffer(uint256 _loanTokenId, uint256 _loanAmount, uint256 _interest, uint256 _loanDuration) public returns(uint256){}
